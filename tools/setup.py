...
def main():
    ...
    print("""
  ######################################
  # hatchet_vanilla Development Environment Setup #
  ######################################

  This script will create your hatchet_vanilla dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your hatchet_vanilla project folder:
    [Arma 3 installation directory]\\{} => hatchet_vanilla project folder
    P:\\{}                              => hatchet_vanilla project folder
